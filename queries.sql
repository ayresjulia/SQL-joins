...
-- last_name and count of vehicles. The first_name should be ordered in asc order.
...
-- average price and count of vehicles. The first_name should be ordered in desc order.
